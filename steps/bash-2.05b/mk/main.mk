...
SHLIB_FILES = clktck getcwd getenv oslib setlinebuf strcasecmp strerror strtod \
	...
	xstrchr zcatfd
# strtoimax / strtoumax dropped: musl provides them, so bundling bash's copies
# makes them 'defined twice' at link time.
